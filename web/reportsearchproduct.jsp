<%-- 
    Document   : reportsearchproduct
    Created on : 13 Mar, 2024, 10:18:41 AM
    Author     : palla
--%>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6">
                     ...
                     <h2 class="noo-sh-title-top"><center>Search Product Report</center></h2></br>
                    <div class="col-lg-6">
                       ...
                       <table border="2" width="500px" height="150px" >
                               ...
                               <tr>
                                ...
                                <tr>
                                   <tr><td>SerialNo</td><td>ProductCategory</td><td >ProductName</td><td align="center">Imagepath</td><td>Price</td><td align="center">ProductInfo</td><td>AdminName</td><td>MobileNo</td><td>Address</td></tr>
                                </tr>
...
<tr><td align="center"><%=sno%></td><td><%=pcatgry%></td><td><%=pnm%></td><td><img src="<%=img%>"  width="120" height="120"/></td><td><%=pr%></td><td><%=pinfo%></td><td><%=anm%></td><td><%=mob%></td><td><%=add%></td> <td align="center"><input type="button"name="Order Now" value="Order Now"style="background-color: greenyellow;font-weight: bold;color: black; "onclick="editRecord(<%=rs.getInt(1)%>)"/></td></tr>
