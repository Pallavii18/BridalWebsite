<%-- 
    ...
    Created on : 28 Jan, 2024, 11:48:11 PM
    Author     : palla
--%>
...
<body>
    ...
    <div class="about-box-main"  style="font-family: long">
        <div class="container">
            <div class="row">
				<div class="col-lg-6">
                    <div class="banner-frame"> <img class="img-fluid" src="images/c3.jpg" alt="" />
                    </div>
                </div>
                <div class="col-lg-6">
                    <center>_______________<span style="font-size:500%;color:palevioletred;">&hearts;</span>_______________</center>
                    <h2 class="noo-sh-title-top"><center>Cancel <span>Order</center></span></h2>
                    <form>
                        <table border="2" width="500px" height="400px" bgcolor="lightgray">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td width="250px" align="center"><input type="text" name="txtcno" value="<%=d%>" /></td>
                                </tr>
                                 <tr>
                             ...
                             <td  width="250px" align="center"colspan="2"><input type="submit" value="Cancel" name="Cancel" style="background-color: gray"/>
...
if(cdate!=null && cdate!="" && oid1!=null && oid1!="" && rea!=null && rea!="")
{
   ...
   String str1="insert into cancel_order(cancel_no,cancel_date,order_id,order_date,customer_name,product_name,quantity,reason)values("+d+",'"+cdate+"',"+oid1+",'"+odate+"','"+cnm+"','"+pnm+"',"+qunty+",'"+rea+"')";
    int a=st.executeUpdate(str1);
    out.println("<script>alert('Confirm...')</script>");
