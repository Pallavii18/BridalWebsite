<%-- 
    ...
    Created on : 23 Jan, 2024, 3:27:05 AM
    Author     : palla
--%>
...
%>
    ...
    <div class="about-box-main"  style="font-family: long">
        <div class="container">
            <div class="row">
				<div class="col-lg-6">
                    <div class="banner-frame"> <img class="img-fluid" src="images/oc1.jpg" alt="" />
                    </div>
                </div>
                <div class="col-lg-6">
                    <center>_______________<span style="font-size:500%;color:palevioletred;">&hearts;</span>_______________</center>
                    <h2 class="noo-sh-title-top"><center>Order <span>Confirm</center></span></h2>
                    <form>
                        <table border="2" width="500px" height="400px" bgcolor="lightgray">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td width="250px" align="center"><input type="text" name="txtoid" value="<%=c%>" /></td>
                                </tr>
                                 <tr>
                                 ...
                                 <tr>
                                     <td width="250px" align="center"><b>PIN Code</b></td>
                                    <td width="250px" align="center"><input type="text" name="txtpcode" value="" /></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                 ...
                                 <tr>
                                    ...
                                    <td width="250px" align="center"><input type="text" name="txtqunty" value="" /></td>
                                </tr>
                                ...
                                <tr>
                                 <td  width="250px" align="center"><h1><b><input type="submit" value="confirm" name="Conform"  /></b></h1></td>
                              <td  width="250px" align="center" ><a href="payment.jsp"><h1>Payment</h1></a></td>
