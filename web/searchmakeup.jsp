<%-- 
    Document   : searchmakeup
    Created on : 2 Dec, 2023, 2:55:33 AM
    Author     : palla
--%>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6">
                    ...
                    <h2 class="noo-sh-title-top"><center>Search Parlours</center></h2>
            ...
            <div class="row my-4"  style="font-family: long">
                <div class="col-12">
                    <center>  <h2 class="noo-sh-title">More Looks</h2></center>
                    <center>_______________<span style="font-size:500%;color:yellow;">&hearts;</span>_______________</center>
                </div>
                
                <div class="col-sm-6 col-lg-3">
                    <div class="hover-team">
                        <div class="our-team"> <img src="images/img65.jpg" alt="" />
                            <div class="team-content">
                                <h3 class="title">Haldi Makeup</h3> <span class="post"></span> </div>
                            <ul class="social">
                ...
                <div class="col-sm-6 col-lg-3">
                    <div class="hover-team">
                        <div class="our-team"> <img src="images/img68.jpg" alt="" />
                            <div class="team-content">
                                <h3 class="title">Engagement Makeup</h3> <span class="post"></span> </div>
                            <ul class="social">
                ...
                <div class="col-sm-6 col-lg-3">
                    <div class="hover-team">
                        <div class="our-team"> <img src="images/img17.jpg" alt="" />
                            <div class="team-content">
                                <h3 class="title">Weeding Makeup</h3> <span class="post"></span> </div>
                            <ul class="social">
                ...
                <div class="col-sm-6 col-lg-3">
                    <div class="hover-team">
                        <div class="our-team"> <img src="images/img2.jpg" alt="" />
                            <div class="team-content">
                                <h3 class="title">South Wedding Makeup</h3> <span class="post"><u/span> </div>
                            <ul class="social">
