...
public final class reportproorder_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  String nm=(String)session.getAttribute("anm1");
      ...
      out.write("                     <h2 class=\"noo-sh-title-top\"><center>Report Confirm Order</center></h2></br>\n");
      out.write("                    <div class=\"col-lg-6\">\n");
      out.write("                        \n");
      out.write("                        <center><form method=\"post\" name=\"form\">\n");
      out.write("                       <table border=\"2\" width=\"250px\" height=\"150px\" bgcolor=\"lightgray\" >\n");
      out.write("                           \n");
      out.write("                                 ");
      ...
      out.write("                              \n");
      out.write("                                <tr>\n");
      out.write("                                    <td width=\"250px\" align=\"center\"colspan=\"7\"><b>Date</b></td>\n");
      out.write("                                    <td width=\"250px\" align=\"center\"colspan=\"7\"><input type=\"date\" name=\"txtcodate\" value=\"\" /></td>\n");
      out.write("                                </tr>\n");
      out.write("                                <tr>\n");
      out.write("                                    <td width=\"250px\" align=\"center\"colspan=\"7\"><b>Admin Name</b></td>\n");
      out.write("                                    <td width=\"250px\" align=\"center\"colspan=\"7\">");
      out.print(anm1);
      out.write("</td>\n");
      out.write("                                </tr>\n");
      out.write("                                <tr> \n");
      ...
      out.write("                                </tr>\n");
      out.write("                                <tr>\n");
      out.write("                                <tr><td><b><h2>OrderID</h2></b></td><td><b><h2>OrderDate</h2><b></td><td><b><h2>CustomerName</h2></b></td><td><b><h2>MobileNo</h2></b></td><td><b><h2>Address</h2></b></td><td><b><h2>PinCode</h2></b></td><td><b><h2>Id</h2></b></td><td><b><h2>ProductCategory</h2></b></td><td><b><h2>ProductName</h2></b></td><td><b><h2>Price</h2></b></td><td><b><h2>Quantity</h2></b></td><td><b><h2>AdminName</h2></b></td><td><b><h2>MobileNo</h2></b></td></tr>\n");
      out.write("                                </tr>\n");
      out.write("                          \n");
      out.write("\n");
...
String odate1 = request.getParameter("txtcodate");
Statement st=con.createStatement();
        

 String str="select * from confirm_order where order_date='"+odate1+"' and admin_name='"+anm1+"'"; 
                     ResultSet rs=st.executeQuery(str);
                     while(rs.next())
                        {
                            oid=rs.getInt(1);
                            odate1=rs.getString(2);
                            cnm=rs.getString(3);
                            mob=rs.getString(4);
                            add=rs.getString(5);
                            pcode=rs.getInt(6);
