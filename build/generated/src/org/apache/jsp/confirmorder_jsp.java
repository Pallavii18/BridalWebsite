...
String d1=(String)session.getAttribute("sno");
...
String pcatgry=(String)session.getAttribute("pcatgry1");
String pnm=(String)session.getAttribute("pnm1");
String pri=(String)session.getAttribute("pri2");

String anm=(String)session.getAttribute("anm1");
String mob1=(String)session.getAttribute("mob2");

      out.write("\n");
      out.write("    <!-- Start Main Top -->\n");
      out.write("    <header class=\"main-header\"  style=\"font-family: long\">\n");
      ...
      out.write("                    <div class=\"banner-frame\"> <img class=\"img-fluid\" src=\"images/oc1.jpg\" alt=\"\" />\n");
      out.write("                    </div>\n");
      out.write("                </div>\n");
      out.write("                <div class=\"col-lg-6\">\n");
      out.write("                    <center>_______________<span style=\"font-size:500%;color:palevioletred;\">&hearts;</span>_______________</center>\n");
      out.write("                    <h2 class=\"noo-sh-title-top\"><center>Order <span>Confirm</center></span></h2>\n");
      out.write("                    <form>\n");
      out.write("                        <table border=\"2\" width=\"500px\" height=\"400px\" bgcolor=\"lightgray\">\n");
      out.write("                           \n");
      out.write("                            <tbody>\n");
      out.write("                               \n");
      out.write("                                ");
                                ...
                                String str2="select count(*) from confirm_order";
      ...
      out.write("\n");
      out.write("                                <tr>\n");
      out.write("                                    <td width=\"250px\" align=\"center\"><b>Order ID</b></td>\n");
      out.write("                                    <td width=\"250px\" align=\"center\"><input type=\"text\" name=\"txtoid\" value=\"");
      out.print(c);
      out.write("\" /></td>\n");
      out.write("                                </tr>\n");
      out.write("                                 <tr>\n");
      out.write("                                     <td width=\"250px\" align=\"center\"><b>Order Date</b></td>\n");
      out.write("                                    <td width=\"250px\" align=\"center\"><input type=\"date\" name=\"txtodate\" value=\"\" /></td>\n");
      out.write("                                </tr>\n");
      out.write("                                \n");
      out.write("                                 <tr>\n");
      out.write("                                     <td width=\"250px\" align=\"center\"><b>Customer Name</b></td>\n");
      ...
      out.write("                                </tr>\n");
      out.write("                                 <tr>\n");
      out.write("                                     <td width=\"250px\" align=\"center\"><b>Address</b></td>\n");
      out.write("                                    <td width=\"250px\" align=\"center\">");
      out.print(add);
      out.write("</td>\n");
      out.write("                                </tr>\n");
      out.write("                                 \n");
      out.write("                                 <tr>\n");
      out.write("                                     <td width=\"250px\" align=\"center\"><b>PIN Code</b></td>\n");
      out.write("                                    <td width=\"250px\" align=\"center\"><input type=\"text\" name=\"txtpcode\" value=\"\" /></td>\n");
      out.write("                                </tr>\n");
      out.write("                                <tr>\n");
      out.write("                                     <td width=\"250px\" align=\"center\"><b>Id</b></td>\n");
      out.write("                                    <td width=\"250px\" align=\"center\">");
      out.print(d1);
      out.write("</td>\n");
      out.write("                                </tr>\n");
      out.write("                               \n");
      out.write("                                <tr>\n");
      out.write("                                    <td width=\"250px\" align=\"center\"><b>Product Category</b></td>\n");
      out.write("                                     <td width=\"250px\" align=\"center\">");
      out.print(pcatgry);
      out.write("</td>\n");
      out.write("                                </tr>\n");
      out.write("                                <tr>\n");
      out.write("                                    <td width=\"250px\" align=\"center\"><b>Product Name</b></td>\n");
      out.write("                                    <td width=\"250px\" align=\"center\">");
      out.print(pnm);
      out.write("</td>\n");
      out.write("                                </tr>\n");
      ...
      out.write("                             \n");
      out.write("                                 <tr>\n");
      out.write("                                    <td width=\"250px\" align=\"center\"><b>Quantity</b></td>\n");
      out.write("                                    <td width=\"250px\" align=\"center\"><input type=\"text\" name=\"txtqunty\" value=\"\" /></td>\n");
      out.write("                                </tr>\n");
      out.write("                                 \n");
      out.write("                                <tr>\n");
      ...
      out.write("                                </tr>\n");
      out.write("                                <tr>\n");
      out.write("                                 <td  width=\"250px\" align=\"center\"><h1><b><input type=\"submit\" value=\"confirm\" name=\"Conform\"  /></b></h1></td>\n");
      out.write("                              <td  width=\"250px\" align=\"center\" ><a href=\"payment.jsp\"><h1>Payment</h1></a></td>\n");
      out.write("                                   \n");
      out.write("                                </tr>\n");
      out.write("                               \n");
      out.write("                               \n");
...
String pcode=request.getParameter("txtpcode");
String qunty=request.getParameter("txtqunty");


if(odate!=null && odate!="" && pcode!=null && pcode!="" && qunty!=null && qunty!="")
 {
    Statement st5=con.createStatement();
   
   String str5="insert into confirm_order(order_id,order_date,customer_name,mobile_no,address,pin_code,id,product_category,product_name,price,quantity,admin_name,mobile_no2)values("+c+",'"+odate+"','"+cnm+"','"+mob+"','"+add+"',"+pcode+","+d1+",'"+pcatgry+"','"+pnm+"',"+pri+","+qunty+",'"+anm+"','"+mob1+"')";
   int d=st5.executeUpdate(str5);
    out.println("<script>alert('Order Placed Successfully..')</script>");
   
}


session.setAttribute("qunty1", qunty);
      ...
      out.write("                    <center>_______________<span style=\"font-size:500%;color:tomato;\">&hearts;</span>_______________</center>\n");
      out.write("                </div>\n");
