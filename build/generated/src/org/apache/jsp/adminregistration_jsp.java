...
public final class adminregistration_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("{ \n");
      out.write("if( document.mobilenumbervalidation.txtmob.value == \"\" ||\n");
      out.write("isNaN( document.mobilenumbervalidation.txtmob.value) ||\n");
      out.write("document.mobilenumbervalidation.txtmob.value.length != 10 )\n");
      out.write("{\n");
      out.write("alert( \"Please provide a 10 digit no\" );\n");
      out.write("document.mobilenumbervalidation.txtmob.focus() ;\n");
      out.write("\n");
      out.write("return false;\n");
      out.write("}\n");
      out.write("\n");
      out.write("var email = document.mobilenumbervalidation.txtei.value;\n");
      ...
      out.write("document.mobilenumbervalidation.txtei.focus() ;\n");
      out.write("return false;\n");
      out.write("}\n");
      out.write("\n");
      ...
      out.write("                        <li class=\"nav-item\"><a class=\"nav-link\"  style=\"font-family: long; font-size: 18px\" href=\"adminhomepage.jsp\">AdminHomepage</a></li>\n");
      out.write("                        <li class=\"nav-item active\"><a class=\"nav-link\"  style=\"font-family: long; font-size: 18px\" href=\"adminregistration.jsp\">AdminRegistration</a></li>\n");
      out.write("                        <li class=\"nav-item\"><a class=\"nav-link\"  style=\"font-family: long; font-size: 18px\" href=\"logout.jsp\">LogOut</a></li>\n");
      out.write("                        \n");
      out.write("                    </ul>\n");
      out.write("                </div>\n");
      ...
      out.write("                    <div class=\"banner-frame\"> <img class=\"img-fluid\" src=\"images/img97.jpg\" alt=\"\" />\n");
      out.write("                    </div>\n");
      out.write("                                </div>\n");
      out.write("                   <div class=\"col-lg-6\">\n");
      out.write("                       </br></br></br></br> <center>_______________<span style=\"font-size:500%;color:purple;\">&hearts;</span>_______________</center>\n");
      out.write("                      <h2 class=\"noo-sh-title-top\"><center>Admin <span>Registration</center></span></h2>\n");
      out.write("               <form method=\"get\" action=\"\" name=\"mobilenumbervalidation\" onsubmit=\"return(validate());\">\n");
      out.write("                        <table border=\"2\" width=\"500px\" height=\"300px\" bgcolor=\"sea blue\">\n");
      out.write("                           \n");
      out.write("                            <tbody>\n");
      out.write("                                <tr>\n");
      out.write("                                    <td width=\"250px\" align=\"center\"><h3><b>Admin Name</b></h3></td>\n");
      out.write("                                    <td width=\"250px\" align=\"center\"><input type=\"text\" name=\"txtanm\" value=\"\" /></td>\n");
      out.write("                                </tr>\n");
      out.write("                                <tr>\n");
      out.write("                                    <td width=\"250px\" align=\"center\"><h3><b>Mobile No</b></h3></td>\n");
      out.write("                                    <td width=\"250px\" align=\"center\"><input type=\"text\" name=\"txtmob\" value=\"\" /></td>\n");
      out.write("                                </tr>\n");
      out.write("                                <tr>\n");
      out.write("                                    <td width=\"250px\" align=\"center\"><h3><b>Address</b></h3></td>\n");
      out.write("                                    <td width=\"250px\" align=\"center\"><input type=\"text\" name=\"txtadd\" value=\"\" /></td>\n");
      out.write("                                </tr>\n");
      out.write("                               \n");
      out.write("                                <tr>\n");
      out.write("                                    <td width=\"250px\" align=\"center\"><h3><b>Email Id</b></h3></td>\n");
      out.write("                                    <td width=\"250px\" align=\"center\"><input type=\"text\" name=\"txtei\" value=\"\" /></td>\n");
      out.write("                                </tr>\n");
      out.write("                                <tr>\n");
      out.write("                                    <td width=\"250px\" align=\"center\"><h3><b>User Name</b></h3></td>\n");
      out.write("                                    <td width=\"250px\" align=\"center\"><input type=\"text\" name=\"txtunm\" value=\"\" /></td>\n");
      out.write("                                </tr>\n");
      out.write("                                <tr>\n");
      out.write("                                    <td width=\"250px\" align=\"center\"><h3><b>Password</b></h3></td>\n");
      out.write("                                    <td width=\"250px\" align=\"center\"><input type=\"password\" name=\"txtpass\" value=\"\" /></td>\n");
      out.write("                                </tr>\n");
      out.write("                                \n");
      out.write("                                 <tr> \n");
      out.write("                                     <td  width=\"250px\" align=\"center\"colspan=\"2\"><h2><b><input type=\"submit\" value=\"Register\" name=\"Register\" style=\"background-color: purple\" /></b></h2></td>\n");
      out.write("                                   \n");
      out.write("                                </tr>\n");
      out.write("                               \n");
      out.write("                            </tbody>\n");
...
String nm = request.getParameter("txtanm");
String mob = request.getParameter("txtmob");
String add = request.getParameter("txtadd");
String email = request.getParameter("txtei");
String unm = request.getParameter("txtunm");
String pass = request.getParameter("txtpass");

if(nm!=null && nm!="" && mob!=null && mob!="" && add!=null && add!="" && email!=null && email!="" && unm!=null && unm!="" && pass!=null && pass!="" )
{
 Statement st=con.createStatement();
 String str="insert into admin_registration(name,mobile_no,address,email_id,user_name,password)values('"+nm+"','"+mob+"','"+add+"','"+email+"','"+unm+"','"+pass+"')";
 int a=st.executeUpdate(str);
 out.println("<script>alert('Your Registration Sucess')</script>");
}
