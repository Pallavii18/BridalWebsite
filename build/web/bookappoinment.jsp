<%-- 
    Document   : bookappoinment
    Created on : 2 Dec, 2023, 1:18:11 AM
    Author     : palla
--%>
...
<body>
    ...
    <div class="about-box-main"  style="font-family: long">
        <div class="container">
            <div class="row">
				<div class="col-lg-6">
                    <div class="banner-frame"> <img class="img-fluid" src="images/book.jpg" alt="" />
                    </div>
                </div>
                <div class="col-lg-6">
                    <center>_______________<span style="font-size:500%;color:coral;">&hearts;</span>_______________</center>
                    <h2 class="noo-sh-title-top"><center>Book <span>Appoinment</center></span></h2>
                    <form>
                        <table border="2" width="500px" height="400px" bgcolor="lightyellow">
                            ...
                            <tbody>
                              ...
                              while(rs4.next())
                                ...
                                <tr> 
                                    <td  width="250px" align="center"colspan="2" style="background-color: yellow"><a href="appoinmentconfirm.jsp"><h1>Next</h1></a></td>
                                </tr>
                            </tbody>
                        </table>
<%
