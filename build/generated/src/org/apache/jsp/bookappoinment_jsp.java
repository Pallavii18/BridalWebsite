...
public final class bookappoinment_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    String d1=request.getParameter("id");
      ...
      out.write("                    <div class=\"banner-frame\"> <img class=\"img-fluid\" src=\"images/book.jpg\" alt=\"\" />\n");
      out.write("                    </div>\n");
      out.write("                </div>\n");
      out.write("                <div class=\"col-lg-6\">\n");
      out.write("                    <center>_______________<span style=\"font-size:500%;color:coral;\">&hearts;</span>_______________</center>\n");
      out.write("                    <h2 class=\"noo-sh-title-top\"><center>Book <span>Appoinment</center></span></h2>\n");
      out.write("                    <form>\n");
      out.write("                        <table border=\"2\" width=\"500px\" height=\"400px\" bgcolor=\"lightyellow\">\n");
      out.write("                           \n");
      out.write("                            <tbody>\n");
      out.write("                               \n");
      out.write("                                \n");
      ...
      out.write("                                  ");
                              ...
                              String str4="select * from add_makeup_info where id="+d1+" ";
                              ResultSet rs4=st4.executeQuery(str4);
                              while(rs4.next())
                                {
                                    
                                    parlernm=rs4.getString(2);
                                   mtype=rs4.getString(3);
                                   pacnm=rs4.getString(4);
                                   pr=rs4.getInt(5);
                                   anm=rs4.getString(7);
      ...
      out.write("                                </tr>\n");
      out.write("                                <tr> \n");
      out.write("                                    <td  width=\"250px\" align=\"center\"colspan=\"2\" style=\"background-color: yellow\"><a href=\"appoinmentconfirm.jsp\"><h1>Next</h1></a></td>\n");
      out.write("                                </tr>\n");
      out.write("                            </tbody>\n");
      out.write("                        </table>\n");

String d2=String.valueOf(d1);
session.setAttribute("d1",d2);
session.setAttribute("cnm1", cnm);
session.setAttribute("mob1", mob);
session.setAttribute("add1", add);

session.setAttribute("palernm1", parlernm);
session.setAttribute("mtype1", mtype);
session.setAttribute("pacnm1", pacnm);
String pri1=String.valueOf(pr);
session.setAttribute("pr1", pri1);
