<%-- 
    Document   : searchmakeupappoinment
    Created on : 2 Dec, 2023, 8:12:37 AM
    Author     : palla
--%>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6">
                    ...
                    <h2 class="noo-sh-title-top"><center>Search Makeup Appoinment</center></h2></br>
                    <form>
                        <center><table border="2" width="300px" height="100px" bgcolor="lightyellow" >
                            ...
                            <tbody>
                                <tr>
                                    <td width="250px" align="center"colspan="6"><h2><b>Date</b></h2></td>
                                    <td width="250px" align="center"colspan="6"><input type="date" name="txtodate" value="" /></td>
                                </tr>
                                <tr> 
                                    <td  width="250px" align="center"colspan="12"><h2><b><input type="submit" value="Search" name="Search" style="background-color:yellow" /></b></h2></td>                                    
                                </tr>
                                 <tr>
                                </tr><td>OrderId</td> <td>orderDate</td><td>ClientName</td><td>MobieNo</td><td>Address</td><td>Id</td><td>ParlerName</td><td>MakeupType</td><td>PackageName</td><td>Price</td><td>AdminName</td><td>MobileNo</td></tr>
                                </tr>
                                 <%
                                int oid=0;
                                String odate=null;
                     ...
                     while(rs.next())
                        {
                            ...
                            mob2=rs.getString(12);
                                        ...
                                        %>
                                     <tr><td><%=oid%></td><td><%=odate%></td><td><%=cnm%></td><td><%=mob%></td><td><%=add%></td><td><%=id%></td><td><%=pnm%></td><td><%=mtype%></td><td><%=pacnm%></td><td><%=pr%></td><td><%=anm%></td><td><%=mob2%></td>
                                </tr>
